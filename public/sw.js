const CACHE='resurgence-city-schools-attendance-v1';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['/','/index.html','/staff-login.html','/manifest.json'])))});
